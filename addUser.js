'use strict';
// Задача скрипта - создать нового пользователя через консоль (запуск - node addUser.js)

//подключаем модули
const mongoose = require('mongoose');
const readline = require('readline'); //для получения данных из консольного приложения
...
rl.on('close', () => { //обработчик на close
  ...
  User
    ...
    .then(() => mongoose.connection.close(function () {
      process.exit(0); // закрытие соединения с базой данных
    }));
});